...
// role="gridcell" <td> — clicking/focusing the <td> itself (its accessible
// name is just the day number) does nothing, confirmed by probing this
// directly. Every scenario below targets the inner button by that label.
describe('Calendar', () => {
