...
export const inputGroupAddonVariants = cva(
  'text-neutral-900/60 h-auto gap-2 py-1.5 text-base font-regular group-data-[disabled=true]/input-group:opacity-50 flex cursor-text items-center justify-center select-none',
  {
    variants: {
      align: {
